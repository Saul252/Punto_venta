...
: '<span class="badge bg-success">Sin adeudo</span>' ?>
                    ...
                    <form id="formCliente">
                        ...
                        <div class="row g-3">
                            ...
                            <div class="col-md-12">
                                ...
                                <textarea name="direccion_fiscal" id="direccion_fiscal" class="form-control"></textarea>
                            </div>
    ...
    buscador.addEventListener('keyup', () => {
        ...
        document.querySelectorAll('#tablaClientes tbody tr')
    ...
    function editarCliente(id) {
        fetch('/punto/acciones/editar_cliente_ajax.php?id=' + id)
            ...
            .then(resp => {
                ...
                razon_social.value = c.razon_social ?? ''
                rfc.value = c.rfc ?? ''
                documento.value = c.documento ?? ''
                telefono.value = c.telefono ?? ''
                email.value = c.email ?? ''
                direccion_fiscal.value = c.direccion_fiscal ?? ''
                codigo_postal.value = c.codigo_postal ?? ''
